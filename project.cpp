...
vector<string> coupons = {"FREE25", "SAVE25", "HUGE", "EASTY"};
struct comparator
{
...
int main()
{
    ...
    if (x == 1)
    {
        ...
        for (int i = 0; i < v.size(); i++)
        {
            ...
            cout << ". ";
            cout.width(50);
            cout << left << places[v[i].ff.ff] << "\t";
            cout.width(4);
            cout << left << "Rs" << v[i].ff.ss << "\t   ";
            cout.width(5);
            cout << left << v[i].ss << "mins\n";
        }
        cout << "\n\n";
        ;
    }
...
int printmenu(vector<pair<pair<int, int>, int>> &v1)
{
    ...
    cout << "\t   ";
    cout.width(53);
    cout << left << "Final Price to pay: " << price << "\n\n";
    cout << "\tEnter coupon\n\t";
    string a;
    cin >> a;
    int val = 4;
    ...
    while (val--)
    {
        if (f(a))
        {
            ...
            cout.width(55);
            cout << left << "\tYour final price is: " << (float)0.75 * price << "\n\n";
            break;
        }
        else if (val)
        {
